        ...
        if (error.response && error.response.data && error.response.data.error) {
            ...
            if (OAIError.message && (
                ...
                (OAIError.code === 'invalid_request_error' && OAIError.message.toLowerCase().includes("supported format"))
                 ...
                 userErrorMessage = `Errore formato per file (nome dal client: '${clientOriginalFilename}'): ${OAIError.message}. Formati supportati: flac, mp3, mp4, mpeg, mpga, m4a, ogg, wav, webm.`;
            }
